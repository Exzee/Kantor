...
<head>
    ...
    <title> @yield('title') - MyOffice</title>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">MyOffice</a>
...
<!--Panel Kiri-->
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="{{ url('pegawai') }}"> <i class="menu-icon fa fa-users"></i>Data Pegawai </a>
                    </li>
                    <li>
                        <a href="{{ url('samplemasuk') }}"> <i class="menu-icon fa fa-list-alt"></i>Data Sample Masuk </a>
                    </li>
                    <li>
                        <a href="{{ url('samplekeluar') }}"> <i class="menu-icon fa fa-list-alt"></i>Data Sample Keluar </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
