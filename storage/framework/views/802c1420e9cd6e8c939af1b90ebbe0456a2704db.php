    ...
    <table class="table table-bordered">
      <thead>
        ...
        <tr>
          ...
          <td >: <?php echo e(old('nama',$model->nama)); ?></td>
        </tr>
         
         <tr>
          <th scope="row">Alamat Pegawai</th>
          <td >: <?php echo e(old('alamat',$model->alamat)); ?></td>
        </tr>
        ...
        <tr>
          ...
          <td>: <?php echo e(date('d-M-Y', strtotime(old('tanggal_lahir',$model->tanggal_lahir)))); ?></td>
        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\kantor\resources\views/pegawai/cetak/cetak.blade.php ENDPATH**/ ?>