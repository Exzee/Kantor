    ...
    <table class="table table-bordered">
      <thead>
        ...
        <tr>
          ...
          <td >: <?php echo e(old('id',$model->id_sample_keluar)); ?></td>
        </tr>

        
        <tr>
          <th scope="row">Tanggal Kirim Sample</th>
          <td>: <?php echo e(date('d-M-Y', strtotime( old('tanggal_kirim_sample',$model->tanggal_kirim_sample)))); ?></td>
        </tr>
        ...
        <tr>
          ...
          <td>: <?php echo e(old('tujuan_sample',$model->tujuan_sample)); ?></td>
        </tr>
        ...
        <tr>
          ...
          <td>: <?php echo e(old('rincian_sample_keluar',$model->rincian_sample_keluar)); ?></td>
        </tr>
        </tr>
        ...
        <tr>
          ...
          <td rowspan="10">
            ...
            <img class="img-thumbnail" width="400px" src="<?php echo e(asset('images/samplekeluar/'.$model->foto_sample)); ?>"/>
            <?php endif; ?>
            <?php if(strlen($model->foto_sample)<1): ?>
            <img class="img-thumbnail" width="400px" src="<?php echo e(asset('images/samplekeluar/blank-img.jpg')); ?>"/>
            <?php endif; ?>
              </td>
        </tr>
        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\kantor\resources\views/samplekeluar/cetak/cetak.blade.php ENDPATH**/ ?>