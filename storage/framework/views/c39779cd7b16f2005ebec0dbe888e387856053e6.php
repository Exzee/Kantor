                        ...
                        <div class="row form-group">
                         ...
                         <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9"><input type="text" id="text-input" name="alamat" placeholder="Alamat Pegawai" class="form-control" id="validationCustom12" value="<?php echo e(old('alamat',$model->alamat)); ?>" required><small class="form-text text-muted"></small></div>
                        </div>
                  ...
                  <?php /**PATH C:\xampp\htdocs\laravel\kantor\resources\views/pegawai/_FormCreate.blade.php ENDPATH**/ ?>