...
<head>
    ...
    <title>MyOffice Admin - Login</title>
    <meta name="description" content="Sufee Admin - HTML5 Admin Template">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="apple-touch-icon" href="<?php echo e(asset('template/apple-icon.png')); ?>">
    ...
    <!-- <link rel="stylesheet" href="<?php echo e(asset('template/assets/css/bootstrap-select.less')); ?>"> -->
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">                   
                        ...
                        <button type="button" class="btn btn-danger btn-lg btn-block">Admin Panel</button>                   
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\kantor\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>